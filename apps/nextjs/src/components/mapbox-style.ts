...
export const mapboxStyle: ExtendedStyleSpecification = {
  version: 8,
  metadata: {
    'mapbox:type': 'default',
    ...
    'mapbox:thumb':
      'data:image/webp;base64,',
  ...
  center: [152.83725608576202, -31.73714102418358],
  zoom: 5.916937942480171,
  bearing: 0,
  pitch: 0,
  fog: {
    'color': 'hsl(0, 0%, 0%)',
  ...
  sprite: 'mapbox://sprites/ryanpwaldon/clywngg34006701r5h2s9asfd/a8aw4ezay5rpm05ma4w889rvp',
  ...
  layers: [
    {
      ...
      layout: {},
      paint: {
        'background-color': ['interpolate', ['linear'], ['zoom'], 9, '#27272a', 11, '#27272a'],
      },
    },
    {
      'id': 'national-park',
    ...
    },
    {
      ...
      'paint': {
        'fill-color': [
          ...
          ['zoom'],
          14,
          ['match', ['get', 'class'], 'shadow', 'hsla(0, 0%, 32%, 0.06)', 'hsla(0, 0%, 24%, 0.04)'],
          16,
          ['match', ['get', 'class'], 'shadow', 'hsla(0, 0%, 32%, 0)', 'hsla(0, 0%, 24%, 0)'],
        ],
        'fill-antialias': false,
      },
    },
    ...
    },
    {
      ...
      'layout': {},
      'paint': {
        'fill-color': ['interpolate', ['linear'], ['zoom'], 9, '#27272a', 11, '#27272a'],
      },
    },
    {
      ...
      'paint': {
        ...
        'line-color': ['interpolate', ['linear'], ['zoom'], 9, '#27272a', 11, '#27272a'],
      },
    },
    {
      'id': 'aeroway-polygon',
    ...
    },
    {
      ...
      'paint': {
        'line-color': ['interpolate', ['linear'], ['zoom'], 13, '#18181b', 17, '#09090b'],
    ...
    },
    {
      ...
      'filter': [
        'all',
        ['==', ['get', 'admin_level'], 0],
        ['match', ['get', 'disputed'], ['false', 'true'], true, false],
        ['==', ['get', 'maritime'], 'false'],
    ...
    },
    {
      ...
      'layout': {
        ...
        'text-max-angle': 30,
        'text-font': ['Martian Mono Regular', 'Martian Mono Regular'],
    ...
    },
    {
      ...
      'layout': {
        'text-font': ['Martian Mono Light', 'Martian Mono Regular'],
        'text-max-angle': 30,
    ...
    },
    {
      ...
      'layout': {
        ...
        'text-max-angle': 30,
        'text-field': ['coalesce', ['get', 'name_en'], ['get', 'name']],
        'text-font': ['Martian Mono Medium', 'Martian Mono Regular'],
    ...
    },
    {
      ...
      'paint': {
        'text-color': ['step', ['get', 'symbolrank'], '#f4f4f5', 11, '#d4d4d8', 16, 'hsl(0, 0%, 47%)'],
        'text-halo-color': '#09090b',
        'text-halo-width': 1,
    ...
    },
    {
      ...
      'layout': {
        ...
        'text-transform': 'uppercase',
        'text-font': ['Martian Mono Bold', 'Martian Mono Bold'],
        'text-field': ['coalesce', ['get', 'name_en'], ['get', 'name']],
