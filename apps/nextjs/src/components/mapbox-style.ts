  ...
  layers: [
    {
      ...
      layout: {},
      paint: {
        'background-color': ['interpolate', ['linear'], ['zoom'], 9, 'hsl(0, 0%, 16%)', 11, 'hsl(0, 0%, 16%)'],
      },
    },
    {
      'id': 'national-park',
    ...
    },
    {
      ...
      'layout': {},
      'paint': {
        'fill-color': ['interpolate', ['linear'], ['zoom'], 9, 'hsl(0, 0%, 16%)', 11, 'hsl(0, 0%, 16%)'],
      },
    },
    {
      ...
      'paint': {
        ...
        'line-color': ['interpolate', ['linear'], ['zoom'], 9, 'hsl(0, 0%, 16%)', 11, 'hsl(0, 0%, 16%)'],
      },
    },
    {
      'id': 'aeroway-polygon',
    ...
    },
    {
      ...
      'paint': {
        'line-color': ['interpolate', ['linear'], ['zoom'], 13, 'hsl(0, 0%, 14%)', 17, 'hsl(0, 0%, 12%)'],
    ...
    },
    {
      ...
      'paint': {
        'text-color': ['step', ['get', 'symbolrank'], 'hsl(0, 0%, 66%)', 11, 'hsl(0, 0%, 53%)', 16, 'hsl(0, 0%, 47%)'],
        'text-halo-color': 'hsl(0, 0%, 3%)',
        'text-halo-width': 1,
